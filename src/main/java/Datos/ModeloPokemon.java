...
public class ModeloPokemon {
    ...
    private int id = 0;
    private String name = "AQUI NO HAY NADA";
    private String forme_name = "AQUI NO HAY NADA";
    private String forme_base_pokemon_id = "AQUI NO HAY NADA";
    private String generation_id = "AQUI NO HAY NADA";
    private String evolution_chain_id = "AQUI NO HAY NADA";
    private String evolution_parent_pokemon_id = "AQUI NO HAY NADA";
    private String evolution_method_id = "AQUI NO HAY NADA";
    private String evolution_parameter = "AQUI NO HAY NADA";
    private String height = "AQUI NO HAY NADA";
    private String weight = "AQUI NO HAY NADA";
    private String species = "AQUI NO HAY NADA";
    private String color = "AQUI NO HAY NADA";
    private String pokemon_shape_id = "AQUI NO HAY NADA";
    private String habitat = "AQUI NO HAY NADA";
    private String gender_rate = "AQUI NO HAY NADA";
    private String capture_rate = "AQUI NO HAY NADA";
    private String base_experience = "AQUI NO HAY NADA";
    private String base_happiness = "AQUI NO HAY NADA";
    private String gen1_internal_id = "AQUI NO HAY NADA";
    private String is_baby = "AQUI NO HAY NADA";
    private String has_gen4_fem_sprite = "AQUI NO HAY NADA";
    private String has_gen4_fem_back_sprite = "AQUI NO HAY NADA";
